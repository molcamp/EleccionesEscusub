...
if ($_SESSION['usuario']) {
   ...
   else if ($_SESSION['admin']!='rosales'){
  ...
  <head>
    ...
    <style>
       ...
       /* background-color: #E1F4DD;*/
        ...
        background:url("https://www.elcairotravel.tur.ar/wp-content/uploads/2017/12/Paisaje-Quebrada-de-Cafayate-a-Salta-Argentina-2.jpg") no-repeat center center fixed;
    ...
    " role="navigation" style="background-color: #214D11">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="admin" class="navbar-brand headerFont text-lg"><strong>Elecciones Casino de Suboficiales</strong></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          ...
          <span class="normalFont"><a href="login" class="btn btn-success navbar-right navbar-btn"><strong>Panel De Usuario</strong></a></span>
        </div>
    	...
    	<div class="row">
    		...
    		<div class="col-sm-4" style="background-color: #f7f7f7;padding:50px;">
    			...
    			<div class="page-header">
    				<h2 class="specialHead">Autenticación de Admin</h2>
    			</div>
