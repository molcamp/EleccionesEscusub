    ...
    " role="navigation" style="background-color: #214D11">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="amuse" class="navbar-brand headerFont text-lg"><strong>Elecciones Casino de Suboficiales</strong></a>
        </div>
          ...
          <?php
                      ...
                      else
                      {
                        ...
                        if(mysqli_num_rows($query)==1)
                        {
                          ...
                          if ($admin_username=="rosales"){
                        //    session_start();
                            $_SESSION['admin2001'] = $admin_username;
                        //    header("location:amuse");
                             echo "<script> 
                                <!--
                                window.location.replace('amuse'); 
                                 //-->
                                </script>";
                         ...
                         //   header("location:cpanel1");
                            echo "<script> 
                                <!--
                                window.location.replace('cpanel1'); 
                                 //-->
                                </script>";
                              }
                        }
                        else
                        {
                          ...
                          echo "<br><a href='admin' class='btn btn-primary'><span class='glyphicon glyphicon-refresh'></span> <strong>Intentalo otra vez</strong></a>";
                        }
